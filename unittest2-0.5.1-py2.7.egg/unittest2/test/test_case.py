...
class Test_TestCase(unittest2.TestCase, EqualityMixin, HashingMixin):
    ...
    def testEquality(self):
        ...
        b = []
        self.assertRaises(
            unittest2.TestCase.failureException, self.assertListEqual, a, b
        )
        self.assertRaises(
            unittest2.TestCase.failureException,
            self.assertListEqual,
        ...
        d = {}
        self.assertRaises(
            unittest2.TestCase.failureException, self.assertDictEqual, c, d
        )
    ...
    def testInequality(self):
        ...
        self.assertRaises(
            self.failureException, self.assertGreaterEqual, u"ant", u"bug"
        )
...
"""
    ...
    def testAssertRegexpMatches(self):
        ...
        self.assertRaises(
            self.failureException, self.assertRegexpMatches, "saaas", r"aaaa"
        )
