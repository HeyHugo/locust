...
class TestInspectLocust(unittest.TestCase):
    def test_get_task_ratio_dict_relative(self):
        ...
        self.assertEqual(
            0.5, ratio["MyLocust"]["tasks"]["MySubLocust"]["tasks"]["task1"]["ratio"]
        )
        self.assertEqual(
            0.5, ratio["MyLocust"]["tasks"]["MySubLocust"]["tasks"]["task2"]["ratio"]
        )
    ...
    def test_get_task_ratio_dict_total(self):
        ...
        self.assertEqual(0.25, ratio["MyLocust"]["tasks"]["MySubLocust"]["ratio"])
        self.assertEqual(
            0.125, ratio["MyLocust"]["tasks"]["MySubLocust"]["tasks"]["task1"]["ratio"]
        )
        self.assertEqual(
            0.125, ratio["MyLocust"]["tasks"]["MySubLocust"]["tasks"]["task2"]["ratio"]
        )
